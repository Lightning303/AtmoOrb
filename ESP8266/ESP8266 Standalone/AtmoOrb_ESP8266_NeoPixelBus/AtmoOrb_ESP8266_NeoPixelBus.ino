...
#define LED_DATA_METHOD 0 // (0=DMA, 1=UART, 2=BitBang)
...
WiFiUDP Udp;
#if LED_DATA_METHOD == 0
  NeoPixelBus<NeoGrbFeature, Neo800KbpsMethod> strip(NUM_LEDS, 3);
#elif LED_DATA_METHOD == 1
  NeoPixelBus<NeoGrbFeature, NeoEsp8266Uart800KbpsMethod> strip(NUM_LEDS, 2);
#elif LED_DATA_METHOD == 2
  NeoPixelBus<NeoGrbFeature, NeoEsp8266BitBang800KbpsMethod> strip(NUM_LEDS, DATA_PIN);
#endif
...
{  
  ...
  {
    strip.ClearTo(RgbColor((STARTUP_RED * RED_CORRECTION) / 255, (STARTUP_GREEN * GREEN_CORRECTION) / 255, (STARTUP_BLUE * BLUE_CORRECTION) / 255));
    strip.Show();
  }
